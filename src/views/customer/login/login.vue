<template>
    <div class="login">
        <div class="head">
            ...
            <p class="logoTitle">平&nbsp;&nbsp;台&nbsp;&nbsp;采&nbsp;&nbsp;购&nbsp;&nbsp;移&nbsp;&nbsp;动&nbsp;&nbsp;端</p>
            <div class="loginForm">
                ...
                <van-checkbox 
                    ...
                    style="padding: 5px 10px;">记住密码</van-checkbox>

                 <van-button type="info"
                        loading-type="spinner"
                        loading-text="登 录 中..." @click="hanldSubClick" class="idea_btn">登 录
                </van-button>
...
import { setTimeout } from 'timers';
    ...
    export default {
        ...
        components: {
            Field, Button, Toast, Checkbox, CheckboxGroup
        },
